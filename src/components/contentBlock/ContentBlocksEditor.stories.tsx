...
const FormWrapper = ({ defaultValues }: { defaultValues?: ContentBlock[] }) => {
      ...
      defaultValues: [
        { type: 'text', content: '<p>First text block with content.</p>' },
        {
          ...
          images: [
            {
              id: '1',
              url: 'https://placehold.co/400x400/e2e8f0/64748b?text=Gallery+1',
              caption: 'First photo',
              alt: 'Placeholder 1',
            },
            {
              id: '2',
              url: 'https://placehold.co/400x400/fecaca/991b1b?text=Gallery+2',
        ...
        },
        {
          type: 'text',
          content:
            '<h2>Second Block</h2><p>More <strong>rich text</strong> here.</p>',
        },
      ],
    }),
};
